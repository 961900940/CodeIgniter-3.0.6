...
$db['default'] = array(
	...
	'database' => 'onethink',	//你需要连接的数据库名. 
	'dbdriver' => 'mysqli',		//数据库类型。如：mysql、postgres、odbc 等。必须为小写字母。
	'dbprefix' => 'onethink_',	//当运行Active Record查询时数据表的前缀,它允许在一个数据库上安装多个CodeIgniter程序. 
	'pconnect' => FALSE,		//TRUE/FALSE (boolean) - 使用持续连接. 
	// 'db_debug' => (ENVIRONMENT !== 'production'),
	'db_debug' => TRUE,			//TRUE/FALSE (boolean) - 显示数据库错误信息. 	
	'cache_on' => FALSE,		//TRUE/FALSE (boolean) - 数据库查询缓存是否开启
